...
def login():
	...
	try:
		...
		if pssd_wr == k: 
			...
			print("Sir/Mam YOUR PASSWORD OR USERNAME IS WRONG , Plz enter Again")
			login()
...
def signup():
	...
	password = input("Enter a password: ")
	user_information(username, password)
	print("Sir/Mam please proceed towards log in")
	login()
...
def login():
	...
	try:
		...
		if pssd_wr == k: 
			...
			print("Sir/Mam YOUR PASSWORD OR USERNAME IS WRONG")
			login()
...
def task_information(username):
	print("Sir/Mam enter n.o of task you want to ADD")
	j = int(input())
	f1 = open(username, 'a')
...
if __name__ == '__main__':
	...
	print("Sir/Mam are you new to this software")
...
if __name__ == '__main__':
	print("WELCOME TO POOJA`S TASK MANAGER")
	print("Sir/Mam are you new to this software")
	a = int(input("Type 1 if new otherwise press 0 ::"))
	if a == 1:
		signup()
